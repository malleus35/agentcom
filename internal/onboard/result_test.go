...
func TestResultValidate(t *testing.T) {
	tests := []struct {
		...
		{name: "valid project", result: Result{HomeDir: "/tmp/agentcom", Project: "demo-app", Confirmed: true}},
		...
		{name: "missing project", result: Result{HomeDir: "/tmp/agentcom", Project: "", Confirmed: true}, wantErr: false},
		{name: "invalid project", result: Result{HomeDir: "/tmp/agentcom", Project: "Demo App", Confirmed: true}, wantErr: true},
